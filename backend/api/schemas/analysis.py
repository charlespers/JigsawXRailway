...
class AnalysisRequest(BaseModel):
    ...
    provider: Optional[str] = Field(default="xai", description="LLM provider: 'xai' (OpenAI support removed)")
...
class ComplianceAnalysisRequest(AnalysisRequest):
    ...
    regions: Optional[List[str]] = Field(default_factory=lambda: ["EU", "US", "China"])
...
class ComplianceAnalysisResponse(BaseModel):
    ...
    rohs: Dict[str, Any]
    reach: Dict[str, Any]
    conflict_minerals: Dict[str, Any]
    waste_directive: Dict[str, Any]
    overall_compliance: str  # compliant, non_compliant
