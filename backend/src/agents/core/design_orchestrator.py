...
class DesignOrchestrator:
    ...
    def generate_design(self, query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # CRITICAL: Ensure selected_parts is a dict before generating outputs
            # Use inline check to avoid circular import
            selected_parts = self.design_state.get("selected_parts", {})
                ...
                if isinstance(selected_parts, list):
                    ...
                    for i, part in enumerate(selected_parts):
                        if isinstance(part, dict):
                            ...
                            converted[key] = part
                    self.design_state["selected_parts"] = converted
                else:
    ...
    def _select_supporting_part(
        ...
        for candidate in ranked[:5]:  # Evaluate top 5 candidates
            ...
            cost = safe_extract_cost(cost_estimate, default=0.0)
            if cost > 0:
